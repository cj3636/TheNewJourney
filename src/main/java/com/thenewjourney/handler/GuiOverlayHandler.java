...
public class GuiOverlayHandler {
    ...
    private String getHeldDurability(EntityPlayer player, int posX, int posY) {
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() instanceof ZirconiumStaff) {
        ...
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() instanceof AquisStaff) {
            int numberBlock = player.hurtResistantTime;
            String durabilitytext = "" + numberBlock;
            int durabilityItem = player.getHeldItemMainhand().getMaxDamage();
            durabilityItem -= player.getHeldItemMainhand().getItemDamage();
        ...
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() instanceof ItemHoe) {
            int durabilityItem = player.getHeldItemMainhand().getMaxDamage();
            durabilityItem -= player.getHeldItemMainhand().getItemDamage();
            String durabilitytext = "" + durabilityItem;
            return durabilitytext;
        ...
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() instanceof Item) {
            int numberBlock = player.getHeldItemMainhand().getCount();
            String durabilitytext = "" + numberBlock;
            return durabilitytext;
        }
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem().getMaxDamage() > 0) {
            int numberBlock = player.getHeldItemMainhand().getCount();
            String durabilitytext = "" + numberBlock;
            return durabilitytext;
        }
    ...
    private int getHeldColor(EntityPlayer player) {
        ...
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() instanceof ModSwordRegistry) {
            return 0xff0000;
        }
        if (player.getHeldItemMainhand() != null && player.getHeldItemMainhand().getItem() instanceof ItemTool) {
            return 0x0000cc;
    ...
    public void tooltipEvent(ItemTooltipEvent event) {
        ...
        if (item instanceof ItemTool) {
            event.getToolTip().add("\u00A7a" + "Harvest Level: " + ((ItemTool) item).getHarvestLevel(event.getItemStack(), ((ItemTool) item).getToolMaterialName(), event.getEntityPlayer(), null));
        }
    }
}
