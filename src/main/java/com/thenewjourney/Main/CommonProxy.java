...
import com.thenewjourney.blocks.pervateki.PowerAdapterTileEntity;
...
public class CommonProxy {
    ...
    public void init(FMLInitializationEvent e) {
        ...
        GameRegistry.registerTileEntity(ImbuedCaulronTileEntity.class, new ResourceLocation(Ref.MODID, "ImbuedCauldronTileEntity"));
        ...
        GameRegistry.registerTileEntity(PowerAdapterTileEntity.class, new ResourceLocation(Ref.MODID, "PowerAdapterTileEnergy"));
        GameRegistry.registerTileEntity(ReactorMediumTileEntity.class, new ResourceLocation(Ref.MODID, "ReactorMediumTileEntity"));
