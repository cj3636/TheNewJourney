...
public class CommonProxy {
    ...
    public void init(FMLInitializationEvent e) {
        ...
        //TileEntities
        GameRegistry.registerTileEntity(GraniteFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "GraniteFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(AndesiteFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "AndesiteFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(DioriteFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "DioriteFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(NetherrackFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "NetherrackFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(NetherBrickFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "NetherBrickFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(BrickFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "BrickFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(CrystalTileEntity.class, new ResourceLocation(Ref.MODID, "CrystalTileEntity").toString());
        GameRegistry.registerTileEntity(DrawerTileEntity.class, new ResourceLocation(Ref.MODID, "DrawerTileEntity").toString());
        GameRegistry.registerTileEntity(BlastFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "BlastFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(InfuserTileEntity.class, new ResourceLocation(Ref.MODID, "InfuserTileEntity").toString());
        GameRegistry.registerTileEntity(TileEntityDistortedBricks.class, new ResourceLocation(Ref.MODID, "TileEntityDistortedBricks").toString());
        GameRegistry.registerTileEntity(ApiaryTileEntity.class, new ResourceLocation(Ref.MODID, "ApiaryTileEntity").toString());
        GameRegistry.registerTileEntity(InversionTileEntity.class, new ResourceLocation(Ref.MODID, "InversionTileEntity").toString());
        GameRegistry.registerTileEntity(ImbuedCaulronTileEntity.class, new ResourceLocation(Ref.MODID, "ImbuedCauldronTileEntity").toString());
        GameRegistry.registerTileEntity(PurifierTileEntity.class, new ResourceLocation(Ref.MODID, "PurifierTileEntity").toString());
        GameRegistry.registerTileEntity(ArcaneFurnaceTileEntity.class, new ResourceLocation(Ref.MODID, "ArcaneFurnaceTileEntity").toString());
        GameRegistry.registerTileEntity(ArcanePillarTileEntity.class, new ResourceLocation(Ref.MODID, "ArcanePillarTileEntity").toString());
        GameRegistry.registerTileEntity(StoneManTileEntity.class, new ResourceLocation(Ref.MODID, "StoneManTileEntity").toString());
        GameRegistry.registerTileEntity(ForgeBlockTileEntity.class, new ResourceLocation(Ref.MODID, "ForgeBlockTileEntity").toString());
        GameRegistry.registerTileEntity(IdolTileEntity.class, new ResourceLocation(Ref.MODID, "IdolTileEntity").toString());
        GameRegistry.registerTileEntity(CrystalProviderTileEntity.class, new ResourceLocation(Ref.MODID, "CrystalProviderTileEntity").toString());
        GameRegistry.registerTileEntity(DuplicatorTileEntity.class, new ResourceLocation(Ref.MODID, "DuplicatorTileEntity").toString());
        GameRegistry.registerTileEntity(BerryBushTileEntity.class, new ResourceLocation(Ref.MODID, "BerryBushTileEntity").toString());
