...
public class InfuserRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements net.minecraftforge.common.crafting.IShapedRecipe {
    /**
    ...
    public InfuserRecipes(String group, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result) {
        this.group = group;
    ...
    public NonNullList<ItemStack> getRemainingItems(InfuserInventoryCrafting inv) {
    ...
    private boolean checkMatch(InventoryCrafting p_77573_1_, int p_77573_2_, int p_77573_3_, boolean p_77573_4_) {
        if (!p_77573_1_.getName().equals("container.infuser")) {
            return false;
        }
    ...
    public static InfuserRecipes deserialize(JsonObject p_193362_0_) {
        ...
        return new InfuserRecipes(s, i, j, nonnulllist, itemstack);
    }
