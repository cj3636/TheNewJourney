...
public class BlastFurnaceGuiInventory extends GuiContainer {
    // This is the resource location for the background image
    private static final ResourceLocation texture = new ResourceLocation(Ref.MODID, "textures/gui/blastfurnace.png");
    private BlastFurnaceTileEntity tileEntity;

    public BlastFurnaceGuiInventory(InventoryPlayer invPlayer, BlastFurnaceTileEntity tileInventoryFurnace) {
        super(new BlastFurnaceContainer(invPlayer, tileInventoryFurnace));
...
// draw the fuel remaining bar for each fuel slot flame
        for (int i = 0; i < BlastFurnaceTileEntity.FUEL_SLOTS_COUNT; ++i) {
