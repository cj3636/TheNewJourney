...
public class BlastFurnaceContainer extends Container {
    ...
    private BlastFurnaceTileEntity tileInventoryFurnace;
    ...
    public final int FUEL_SLOTS_COUNT = 2;
    ...
    public BlastFurnaceContainer(InventoryPlayer invPlayer, BlastFurnaceTileEntity tileInventoryFurnace) {
