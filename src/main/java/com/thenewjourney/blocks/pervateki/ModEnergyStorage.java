...
public class ModEnergyStorage {
     ...
     *
     * @param capacity The capacity of the energy storage
     */
     ...
     *
     * @param capacity    The capacity of the energy storage
     * @param maxTransfer The maximum amount of energy which can be received and
     *                    extracted
     */
     ...
     *
     * @param capacity   The capacity of the energy storage
     * @param maxReceive The maximum amount of energy which can be received
     * @param maxExtract The maximum amount of energy which can be extracted
     */
     ...
     * @param maxReceive The maximum amount of energy which can be received
     * @param maxExtract The maximum amount of energy which can be extracted
     * @param energy     The energy inside of the energy storage
     */
     ...
     *
     * @param maxReceive The amount of energy to give
     * @param simulate   Whether it is a simulation - if so, no energy will actually be
     *                   given
     ...
     *
     * @param maxExtract The amount of energy to take
     * @param simulate   Whether it is a simulation - if so, no energy will actually be
     *                   taken
     ...
     *
     * @param maxExtract How much you want to extract
     * @param simulate   Whether it is a simulation
     ...
     * For use only inside your {@link TileEntity}
     *
     * @param maxReceive How much you want to give
     * @param simulate   Whether it is a simulation
     ...
     * @return The {@link ModEnergyStorage} with the new energy
     */
    public ModEnergyStorage setEnergyStored(long energy) {
        this.energy = energy;
        return this;
    }
     ...
     * @return The {@link ModEnergyStorage} with the new capacity
     */
    public ModEnergyStorage setCapacity(long capacity) {
        this.capacity = capacity;
        return this;
    }
     ...
     *
     * @param transfer The max transfer to set
     * @return The {@link ModEnergyStorage} with the new max transfer
     */
    public ModEnergyStorage setMaxTransfer(long transfer) {
     ...
     * @return The {@link ModEnergyStorage} with the new max receive
     */
    public ModEnergyStorage setMaxReceive(long maxReceive) {
        this.maxReceive = maxReceive;
        return this;
    }
     ...
     * @return The {@link ModEnergyStorage} with the new max extract
     */
    public ModEnergyStorage setMaxExtract(long maxExtract) {
        this.maxExtract = maxExtract;
        return this;
    }
