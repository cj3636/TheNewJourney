...
public class DuplicatorGuiInventory extends GuiContainer {
	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation(Ref.MODID, "textures/gui/duplicator.png");
	private DuplicatorTileEntity tileEntity;

	public DuplicatorGuiInventory(InventoryPlayer invPlayer, DuplicatorTileEntity tileInventoryPurifier) {
		super(new DuplicatorContainer(invPlayer, tileInventoryPurifier));
