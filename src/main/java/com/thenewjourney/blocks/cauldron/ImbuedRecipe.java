...
public class ImbuedRecipe implements IRecipe {
    /**
    ...
    public ImbuedRecipe(int width, int height, ItemStack[] p_i1917_3_, ItemStack output) {
    ...
    public boolean canFit(int width, int height) {
        return (width * height) < this.getRecipeSize();
    }
