...
public class ApiaryContainer extends Container {
    ...
    private ApiaryTileEntity tileInventoryApiary;
    ...
    public boolean canInteractWith(EntityPlayer player) {
        return tileInventoryApiary.isUsableByPlayer(player);
    }
    ...
    public void detectAndSendChanges() {
        ...
        boolean fieldHasChanged[] = new boolean[tileInventoryApiary.getFieldCount()];
        if (cachedFields == null) {
            cachedFields = new int[tileInventoryApiary.getFieldCount()];
            allFieldsHaveChanged = true;
        }
        for (int i = 0; i < cachedFields.length; ++i) {
            if (allFieldsHaveChanged || cachedFields[i] != tileInventoryApiary.getField(i)) {
                cachedFields[i] = tileInventoryApiary.getField(i);
        ...
        for (IContainerListener listener : this.listeners) {
            for (int fieldID = 0; fieldID < tileInventoryApiary.getFieldCount(); ++fieldID) {
    ...
    public void addListener(IContainerListener listener) {
        ...
        listener.sendAllWindowProperties(this, tileInventoryApiary);
    }
    ...
    public class SlotInput extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return stack.getItem().equals(ModItems.Bee);
        }
    }
