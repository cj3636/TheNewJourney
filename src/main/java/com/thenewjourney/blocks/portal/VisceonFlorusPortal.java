...
import com.thenewjourney.particle.FlorusParticle;
...
public class VisceonFlorusPortal extends BlockRotatedPillar {

    public static final String name = "Spheref";

    public VisceonFlorusPortal(String unlocalizedName) {
        super(Material.IRON);
        ...
        if (entityIn instanceof EntityPlayer) {
            ...
            if (!worldIn.isRemote) {
                if (playerIn.dimension == 0) {
                    WorldServer worldTo = playerIn.getServer().getWorld(Config.florusDimId);
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
        ...
        for (int i = 0; i < textParticles; i++) {
            ...
            FlorusParticle FlorusEffect = new FlorusParticle(worldIn, pos.getX() + 0.5, pos.getY() + 1.5, pos.getZ() + 0.5, xP, yP, zP);
            Minecraft.getMinecraft().effectRenderer.addEffect(FlorusEffect);

            FlorusParticle FlorusEffect2 = new FlorusParticle(worldIn, pos.getX() + 0.5, pos.getY() + 1.5, pos.getZ() + 0.5, -xP, -yP, -zP);
            Minecraft.getMinecraft().effectRenderer.addEffect(FlorusEffect2);
