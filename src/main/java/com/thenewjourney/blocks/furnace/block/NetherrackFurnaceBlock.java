...
public class NetherrackFurnaceBlock extends BlockContainer {
    ...
    public NetherrackFurnaceBlock(boolean isBurning, String unlocalizedName) {
        super(Material.ROCK);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new NetherrackFurnaceTileEntity();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tileentity instanceof NetherrackFurnaceTileEntity) {
                ((NetherrackFurnaceTileEntity) tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
