...
public class GraniteFurnaceBlock extends BlockContainer {
    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
    private final boolean isBurning;
    private static boolean keepInventory;

    public GraniteFurnaceBlock(boolean isBurning, String unlocalizedName) {
        super(Material.ROCK);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new GraniteFurnaceTileEntity();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tileentity instanceof GraniteFurnaceTileEntity) {
                ((GraniteFurnaceTileEntity) tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
