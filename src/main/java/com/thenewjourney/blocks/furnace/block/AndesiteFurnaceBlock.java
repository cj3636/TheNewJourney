...
public class AndesiteFurnaceBlock extends BlockFurnace {
    private static boolean keepInventory;
    private static int smeltTime;

    public AndesiteFurnaceBlock(boolean isBurning, String unlocalizedName, int smeltTime) {
        super(isBurning);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new AndesiteFurnaceTileEntity(smeltTime);
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(ModBlocks.AndesiteFurnaceIdle);
    }
