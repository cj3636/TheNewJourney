...
public class NetherrackFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public NetherrackFurnaceTileEntity(int smeltTime) {
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(NetherrackFurnaceTileEntity.class, new String[]{"Items"}));
    }
