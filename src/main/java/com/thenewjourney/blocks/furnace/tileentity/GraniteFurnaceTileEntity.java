...
import com.thenewjourney.blocks.furnace.block.GraniteFurnaceBlock;
...
public class GraniteFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                GraniteFurnaceBlock.setState(this.isBurning(), this.world, this.pos);
            }
        }
