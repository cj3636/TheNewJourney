...
public class GraniteFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public GraniteFurnaceTileEntity(int smeltTime) {
        this.smeltTime = smeltTime;
    }

    public GraniteFurnaceTileEntity() {
        this.smeltTime = 200;
    }
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(GraniteFurnaceTileEntity.class, new String[]{"Items"}));
    }
