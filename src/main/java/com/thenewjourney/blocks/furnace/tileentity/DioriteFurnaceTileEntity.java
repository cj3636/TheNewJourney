...
import com.thenewjourney.blocks.furnace.block.DioriteFurnaceBlock;
...
public class DioriteFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                DioriteFurnaceBlock.setState(this.isBurning(), this.world, this.pos);
            }
        }
