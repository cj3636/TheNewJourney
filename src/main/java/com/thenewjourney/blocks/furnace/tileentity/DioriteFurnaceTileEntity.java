...
public class DioriteFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public DioriteFurnaceTileEntity(int smeltTime) {
        this.smeltTime = smeltTime;
    }

    public DioriteFurnaceTileEntity() {
        this.smeltTime = 200;
    }
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(DioriteFurnaceTileEntity.class, new String[]{"Items"}));
    }
