...
import com.thenewjourney.blocks.furnace.block.AndesiteFurnaceBlock;
...
public class AndesiteFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    private static int burnStick = 100;
    private static int burnCoal = 1600;
    private static int burnLava = 20000;
    private static int burnSapling = 100;
    private static int burnBlaze = 2400;
    private static int burnTool = 200;
    private static int burnSlab = 150;
    private static int burnCoalBlock = 16000;
    private static int burnWood = 300;
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                AndesiteFurnaceBlock.setState(this.isBurning(), this.world, this.pos);
            }
        }
