...
public class AndesiteFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public AndesiteFurnaceTileEntity(int smeltTime) {
        this.smeltTime = smeltTime;
    }

    public AndesiteFurnaceTileEntity() {
        this.smeltTime = 200;
    }
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(AndesiteFurnaceTileEntity.class, new String[]{"Items"}));
    }
