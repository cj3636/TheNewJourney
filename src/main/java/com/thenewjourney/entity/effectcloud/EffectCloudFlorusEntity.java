...
import com.thenewjourney.particle.FlorucFireballParticle;
...
public class EffectCloudFlorusEntity extends Entity {
    private Particle thisParticle;
    private static final DataParameter<Float> RADIUS = EntityDataManager.createKey(EffectCloudFlorusEntity.class, DataSerializers.FLOAT);
    private static final DataParameter<Integer> COLOR = EntityDataManager.createKey(EffectCloudFlorusEntity.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> IGNORE_RADIUS = EntityDataManager.createKey(EffectCloudFlorusEntity.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> PARTICLE = EntityDataManager.createKey(EffectCloudFlorusEntity.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> PARTICLE_PARAM_1 = EntityDataManager.createKey(EffectCloudFlorusEntity.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> PARTICLE_PARAM_2 = EntityDataManager.createKey(EffectCloudFlorusEntity.class, DataSerializers.VARINT);
    ...
    public EffectCloudFlorusEntity(World worldIn) {
        super(worldIn);
    ...
    public EffectCloudFlorusEntity(World worldIn, double x, double y, double z) {
        this(worldIn);
    ...
    protected void entityInit() {
        ...
        this.getDataManager().register(PARTICLE, Integer.valueOf(EnumParticleTypes.CRIT.getParticleID()));
            ...
            if (flag) {
                if (this.rand.nextBoolean()) {
                    for (int i = 0; i < 2; ++i) {
                        ...
                        if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
                            ...
                            int l = j >> 8 & 255;
                            int i1 = j & 255;
                            FlorucFireballParticle spawnParticle = new FlorucFireballParticle(this.world, this.posX + (double) f3, this.posY, this.posZ + (double) f4, (double) ((float) k / 255.0F), (double) ((float) l / 255.0F), (double) ((float) i1 / 255.0F));
                            Minecraft.getMinecraft().effectRenderer.addEffect(spawnParticle);
                        } else {
                            FlorucFireballParticle spawnParticle = new FlorucFireballParticle(this.world, this.posX + (double) f3, this.posY, this.posZ + (double) f4, 0.0D, 0.0D, 0.0D);
                            Minecraft.getMinecraft().effectRenderer.addEffect(spawnParticle);
                        }
                    }
                }
                ...
                for (int k1 = 0; (float) k1 < f5; ++k1) {
                    ...
                    if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
                        ...
                        int j2 = l1 >> 8 & 255;
                        int j1 = l1 & 255;
                        FlorucFireballParticle spawnParticle = new FlorucFireballParticle(this.world, this.posX + (double) f8, this.posY, this.posZ + (double) f9, (double) ((float) i2 / 255.0F), (double) ((float) j2 / 255.0F), (double) ((float) j1 / 255.0F));
                        Minecraft.getMinecraft().effectRenderer.addEffect(spawnParticle);
                    } else {
                        FlorucFireballParticle spawnParticle = new FlorucFireballParticle(this.world, this.posX + (double) f8, this.posY, this.posZ + (double) f9, (0.5D - this.rand.nextDouble()) * 0.15D, 0.009999999776482582D, (0.5D - this.rand.nextDouble()) * 0.15D);
                        Minecraft.getMinecraft().effectRenderer.addEffect(spawnParticle);
                    }
                }
            }
