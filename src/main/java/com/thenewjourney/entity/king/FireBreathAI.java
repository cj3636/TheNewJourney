...
public class FireBreathAI extends EntityAIBase {
    ...
    public FireBreathAI(EntityLiving par1EntityLiving, float speed, float range, int time, float chance) {
    ...
    private Entity getHeadLookTarget() {
        ...
        float var9 = 0.5F;
        List<Entity> possibleList = this.entityHost.world.getEntitiesWithinAABBExcludingEntity(this.entityHost, this.entityHost.getEntityBoundingBox().offset(lookVec.x * offset, lookVec.y * offset, lookVec.z * offset).expand(var9, var9, var9));
        double hitDist = 0;
