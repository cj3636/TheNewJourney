...
public class ArcaneWrapper extends BlankRecipeWrapper implements IShapedCraftingRecipeWrapper {

    private final ArcaneRecipe recipe;

    public ArcaneWrapper(ArcaneRecipe recipe) {
        this.recipe = recipe;
