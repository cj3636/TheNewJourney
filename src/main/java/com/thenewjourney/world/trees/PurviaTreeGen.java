package com.thenewjourney.world.trees;
...
public class PurviaTreeGen extends WorldGenAbstractTree {
    private static final IBlockState DARK_OAK_LOG = ModBlocks.PurviaLignumLog.getDefaultState();
    private static final IBlockState DARK_OAK_LEAVES = ModBlocks.PurviaLeaves.getDefaultState().withProperty(LeavesBlock.CHECK_DECAY, Boolean.valueOf(false)).withProperty(LeavesBlock.DECAYABLE, Boolean.valueOf(false));

    public PurviaTreeGen(boolean notify) {
        super(notify);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (k >= 1 && k + i + 1 < 256) {
            ...
            if (!(isSoil && position.getY() < worldIn.getHeight() - i - 1)) {
                ...
                worldIn.setBlockState(blockpos, ModBlocks.PurviaGrass.getDefaultState());
                return true;
            }
        } else {
            return false;
