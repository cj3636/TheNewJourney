...
public class FlorusChunkGenerator implements IChunkGenerator {

    private final World worldObj;
    private Random random;
    private Biome[] biomesForGeneration;

    private List<Biome.SpawnListEntry> mobs = Lists.newArrayList(new Biome.SpawnListEntry(EntityEndermite.class, 100, 2, 2));

    private MapGenBase caveGenerator = new MapGenCaves();
    private FlorusTerrainGenerator terraingen = new FlorusTerrainGenerator();

    public FlorusChunkGenerator(World worldObj) {
