...
public class FlorusTerrainGenerator {
    private World world;
    ...
    public void setBiomesForGeneration(Biome[] biomesForGeneration2) {
        this.biomesForGeneration = new Biome[]{Biomes.EXTREME_HILLS, Biomes.MUTATED_EXTREME_HILLS};
    }
                ...
                for (int height32 = 0; height32 < 32; ++height32) {
                    ...
                    for (int h = 0; h < 8; ++h) {
                        ...
                        for (int x = 0; x < 4; ++x) {
                            ...
                            for (int z = 0; z < 4; ++z) {
                                if (height < 2) {
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, ModBlocks.FlorusBlock.getDefaultState());
    ...
    public IBlockState topBlock = ModBlocks.FlorusBlock.getDefaultState();
    public IBlockState fillerBlock = ModBlocks.FlorusBlock.getDefaultState();
    protected static final IBlockState STONE = ModBlocks.FlorusBlock.getDefaultState();
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = ModBlocks.FlorusBlock.getDefaultState();
    protected static final IBlockState GRAVEL = ModBlocks.FlorusBlock.getDefaultState();
    protected static final IBlockState RED_SANDSTONE = ModBlocks.FlorusBlock.getDefaultState();
    protected static final IBlockState SANDSTONE = ModBlocks.FlorusBlock.getDefaultState();
    protected static final IBlockState ICE = ModBlocks.FlorusBlock.getDefaultState();
        ...
        for (int j1 = 255; j1 >= 0; --j1) {
            if (j1 <= rand.nextInt(5)) {
                ...
                if (iblockstate2.getMaterial() == Material.AIR) {
                    j = -1;
                } else if (iblockstate2.getBlock() == ModBlocks.FlorusBlock) {
                    if (j == -1) {
                        if (k <= 0) {
                            iblockstate = AIR;
                            iblockstate1 = STONE;
