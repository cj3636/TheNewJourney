...
public class RecipeGen {
    ...
    public static void setupDir() {
        if (RECIPE_DIR == null) {
            RECIPE_DIR = new File("C:\\Users\\AdministratorX\\IdeaProjects\\TheNewJourney\\src\\main\\resources\\assets\\thenewjourney\\recipes");
        }
    ...
    public static void addRecipe(ItemStack result, Object... components) {
        ...
        // GameRegistry.addRecipe(result, components);
